...
import services.storage.productos.ProductoFicheroSerializableService
...
fun main(args: Array<String>) {
    ...
    val productosRepository = ProductosRepositoryMap(ProductoFicheroSerializableService)
    val productosController = ProductosController(productosRepository)
    val carritoController = VentasController(VentasRepositoryMap, productosRepository)
